...
public class FrmPacientes extends javax.swing.JInternalFrame {
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        if (cpacientes.actualizarPaciente()==true) {
            JOptionPane.showMessageDialog(null, "Se actualizo la informacion del pacioente de forma exitosa");
        }else{
           JOptionPane.showMessageDialog(null, "No se pudo actualizar la informacion del paciente"); 
        }
